...
This repository provides scripts to generate distribution packages for all the platforms supported. These scripts are included in the director distrib.  
...
- distrib/make-distrib-linux-hl.bat to generate a Linux headless (text mode) distribution from Linux
...
- distrib/make-distrib-ios to generate a iOS distribution from macOS
...
These scripts will generate a directory under distrib with the contents of the distribution. It will also generate a compressed version of the distribution under distrib/_downloads.  
