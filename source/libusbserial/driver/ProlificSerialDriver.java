...
//JC-- import com.hoho.android.usbserial.BuildConfig;
...
//JC--            if(BuildConfig.DEBUG && (baudRate & (3<<29)) == (1<<29)) {
//JC--                return baudRate & ~(1<<29); // for testing purposes accept without further checks
//JC--            }
            if (baudRate <= 0) {
