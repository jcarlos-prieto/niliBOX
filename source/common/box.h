...
public:
    ...
    Q_INVOKABLE void                       audioDevice_close(const int deviceid);
    Q_INVOKABLE QString                    audioDevice_defaultInput();
    Q_INVOKABLE QString                    audioDevice_defaultOutput();
    Q_INVOKABLE QString                    audioDevice_description(const QString &id);
    Q_INVOKABLE bool                       audioDevice_isOpen();
    Q_INVOKABLE bool                       audioDevice_isOpen(const QString &id);
    Q_INVOKABLE QList<QString>             audioDevice_list(const QString &mode = "ALL", bool raw = false);
    Q_INVOKABLE QString                    audioDevice_mode(const QString &id);
    Q_INVOKABLE void                       audioDevice_mute(const int deviceid, const bool mute);
    Q_INVOKABLE int                        audioDevice_open(const QString &devname, const QString &mode, const bool direct = false);
    Q_INVOKABLE void                       audioDevice_recordPause(const int deviceid, const bool pause);
    Q_INVOKABLE void                       audioDevice_recordStart(const int deviceid, const QString filename, const int rawsamplerate = 0);
    Q_INVOKABLE void                       audioDevice_recordStop(const int deviceid);
    Q_INVOKABLE void                       audioDevice_recordWrite(const int deviceid, QByteArrayView data);
    Q_INVOKABLE void                       audioDevice_reset(const int deviceid);
    Q_INVOKABLE void                       audioDevice_setBusy(const int deviceid, const bool busy);
    Q_INVOKABLE void                       audioDevice_setVolume(const int deviceid, const float volume);
    Q_INVOKABLE void                       audioDevice_write(const int deviceid, QByteArrayView data);
    QAudioDevice                           audioDevice_fromId(const QString &id);

    Q_INVOKABLE void                       videoDevice_close(const int deviceid);
    Q_INVOKABLE QList<QString>             videoDevice_configurations(const QString &id);
    Q_INVOKABLE QString                    videoDevice_default();
    Q_INVOKABLE QString                    videoDevice_description(const QString &id);
    Q_INVOKABLE QList<int>                 videoDevice_frameRates(const QString &id);
    Q_INVOKABLE bool                       videoDevice_isOpen();
    Q_INVOKABLE bool                       videoDevice_isOpen(const QString &id);
    Q_INVOKABLE QList<QString>             videoDevice_list();
    Q_INVOKABLE int                        videoDevice_open(const QString &devname, const QString &mode);
    Q_INVOKABLE QString                    videoDevice_orientation(const QString &id);
    Q_INVOKABLE QString                    videoDevice_position(const QString &id);
    Q_INVOKABLE QList<QString>             videoDevice_resolutions(const QString &id);
    Q_INVOKABLE bool                       videoDevice_setConfiguration(const int deviceid, const QString &mode);
    Q_INVOKABLE void                       videoDevice_setQuality(const int deviceid, const int quality);
    Q_INVOKABLE QByteArrayView             videoDevice_takeShot(const int deviceid);
    Q_INVOKABLE QList<int>                 videoDevice_videoFormats(const QString &id);
    QCameraDevice                          videoDevice_fromId(const QString &id);

    Q_INVOKABLE void                       serialPort_close(const int deviceid);
    Q_INVOKABLE QString                    serialPort_description(const QString &id);
    Q_INVOKABLE int                        serialPort_DTR(const int deviceid, const int newDTR = -1);
    Q_INVOKABLE bool                       serialPort_isOpen(const QString &id);
    Q_INVOKABLE QList<QString>             serialPort_list();
    Q_INVOKABLE QString                    serialPort_manufacturer(const QString &id);
    Q_INVOKABLE int                        serialPort_open(const QString &devname, const QString &mode);
    Q_INVOKABLE int                        serialPort_RTS(const int deviceid, const int newRTS = -1);
    Q_INVOKABLE QString                    serialPort_serialNumber(const QString &id);
    Q_INVOKABLE QString                    serialPort_systemLocation(const QString &id);
    Q_INVOKABLE void                       serialPort_write(const int deviceid, const QByteArray &data);
