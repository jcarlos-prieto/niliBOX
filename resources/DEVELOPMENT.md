...
The object names from the core application are predefined (unless you modify the core application). These object names are listed in [Core object names](./API.md#core-object-names).
