...
Also remember that, as mentioned in [Resource collection](#resource-collection) section, the language files for a driver must be included in the collection.qrc file for the driver resource.
