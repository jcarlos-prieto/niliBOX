...
Item {
    ...
    property bool	freqok;
    property bool   ppmok
    property bool   rfgainok;
    property bool   sampleok
    ...
    property int    maxmem
    property int    freqnew;
    property int    ppmnew;
    property int    rfgainnew;
    property int    samplenew
    property int    tau
                        ...
                        TColumn {
                            ...
                            TKnob {
                                ...
                                TButton {
                                    ...
                                    text: "I"
                                    visible: kFrequency.value > -1 && kFrequency.value <= 28800000
                                    onClicked: setDS("I");
                                }
                                TButton {
                                    id: dsQ
                                ...
                                TButton {
                                    ...
                                    font.pixelSize: 0.25 * b_unit
                                    text: "SW"
                                    visible: false //kFrequency.value > -1 && kFrequency.value <= 28800000
                                    onClicked: setDS("SW");
                                }
                            }
                            TRow {
                            ...
                            TRow {
                                ...
                                TColumn {
                                    ...
                                    TButton {
                                        ...
                                        checkable: true
                                        font.pixelSize: 0.25 * b_unit
                                        text: b_translate("AGC<br>AF")
                                        onClicked: setAGCAudio(checked);
                                    }
                                    TButton {
                                        id: bAGCRTL
                                        width: 1.4 * b_unit
                                        ...
                                        checkable: true
                                        font.pixelSize: 0.25 * b_unit
                                        text: b_translate("AGC<br>RTL")
                                        onClicked: setAGCRTL(checked);
                                    }
                                }
                            }
                        }
    ...
    function b_start(params)
    {
        ...
        setFrequency(freq);
        setDS(b_getvar("directsampling", "I"));
        setBand(band);
        setAGCAudio(b_getvar("agcaudio", "false") === "true");
        setAGCRTL(b_getvar("agcrtl", "false") === "true");
        kFilter.value = -1;
        setFilter(filt);
        setSample(b_getvar("sample", 16));
    ...
    function b_receive(key, value)
    {
        if (key === "power") {
            ...
            if (value === "1") {
                ...
                setAGCAudio(bAGCAudio.checked);
                setAGCRTL(bAGCRTL.checked);
    ...
    function setFrequency(value)
    {
        ...
        if (value <= 28800000)
            lField6.text = b_translate("DIRECT");
        else
            lField6.text = "";
    }


    function setDS(value)
    {
        dsI.checked = value === "I";
        dsQ.checked = value === "Q";
        dsSW.checked = value === "SW";

        ds = value;
        b_setvar("directsampling", value);
        if (bPower.status === 1)
            b_send("directsampling", value);
    }
    ...
    function setAGCAudio(checked)
    {
        bAGCAudio.checked = checked;
        b_setvar("agcaudio", checked);
        if (bPower.status === 1)
            b_send("agcaudio", checked);
    }


    function setAGCRTL(checked)
    {
        bAGCRTL.checked = checked;
        b_setvar("agcrtl", checked);
        if (bPower.status === 1)
            b_send("agcrtl", checked);
    }
    ...
    function setRFGain(value)
    {
        ...
        kRFGain.anglestep = 300 / gains.length;
        ...
        if (value === -1)
            ...
            tRFGain.text = (gains[value] / 10) + " dB";
    ...
    function setRecord(value)
    {
        if (value) {
            if (bRecordRAW.checked) {
                ...
                updateRecordSize(44);
                box.audioDevice_recordStart(audiodeviceid, filename, vsample);
