...
Item {
                            ...
                            TRow {
                                ...
                                TColumn {
                                    ...
                                    TButton {
                                        ...
                                        anchors.horizontalCenter: parent.horizontalCenter
                                        checkable: true
                                        text: b_translate("ANL")
                                        onClicked: setANL(checked);
                                    }
                                    TButton {
                                        id: bATT
                                        width: 1.5 * b_unit - b_space
                        ...
                        TGroupBox {
                            ...
                            TColumn {
                                ...
                                TButton {
                                    ...
                                    checkable: true
                                    text: b_translate("REV.<br>ACTION")
    ...
    function b_start(params)
    {
        ...
        setBand(band);
        setFilter(filt);
        setANL(b_getvar("anl", "false") === "true");
    ...
    function b_receive(key, value)
    {
        if (key === "power") {
            ...
            for (let i = 0; i < data.length / 2; i++)
                view[i] = parseInt(data.substr(2 * i, 2), 16);
    ...
    {
        box.audioDevice_mute(audiodeviceid, checked);
    ...
    function setSpan(value)
    {
        if (value === 1) {
            ...
            tSpan.text = "2 MHz";
            kSpan.bandwidth = 2000000;
        } else if (value === 4) {
            tSpan.text = "4 MHz";
            kSpan.bandwidth = 4000000;
        }
    ...
    function setTSQL(value)
    {
        ...
        bReverseAction.enabled = kTSQL.enabled;
        if (bPower.status === 1)
            b_send("tsql", value);
    }
